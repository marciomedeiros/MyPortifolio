		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "MyPortifolio",
									"targetURL": "#myportifolio-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"myportifolio-display": {
								"semanticObject": "myportifolio",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=myportifolio",
									"url": sap.ui.require.toUrl("myportifolio")
								}
							}
						}
					}
